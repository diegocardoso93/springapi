...
public class EnderecoController {
    ...
    @Operation(summary = "Busca um endereço por ID",
            ...
            parameters = {@Parameter(name = "id", description = "ID do endereço a ser buscado",
    ...
    @Operation(summary = "Cria um novo endereço",
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Dados do endereço a serem criados (DTO)", required = true,
    ...
    public ResponseEntity<EnderecoDTO> createEndereco(@RequestBody EnderecoDTO enderecoDTO) {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(enderecoService.createEndereco(enderecoDTO));
    }
    ...
    @Operation(summary = "Atualiza um endereço existente",
            ...
            parameters = {@Parameter(name = "id", description = "ID do endereço a ser atualizado",
                    required = true, schema = @Schema(type = "integer"))},
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Novos dados para o endereço", required = true,
                    content = @Content(schema = @Schema(implementation = EnderecoDTO.class))),
            responses = {
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Exclui um endereço por ID",
            description = "Exclui um registro de endereço com base no ID fornecido.",
            parameters = {@Parameter(name = "id", description = "ID do endereço a ser excluído",
                    required = true, schema = @Schema(type = "integer"))},
            responses = {
